...
if [[ "$INSTALL_VIA_NIX" == "true" ]]; then
  ...
  if ! [[ "${TARGET_ID}" = "arch" ]]; then
    ...
    if [[ "${tmp_update_status}" =~ ^(OUTDATED|EMPTY_TARGET|EMPTY_SOURCE|FORCE_OUTDATED|WIP)$ ]]; then
      ...
      printf "   ${STY_UNDERLINE}https://github.com/npontious/dots-hyprland/discussions/2140${STY_RST}\n"
      ...
      printf "   ${STY_UNDERLINE}https://github.com/npontious/dots-hyprland/commits/main/sdata/dist-arch${STY_RST}\n"
      printf "   ${STY_UNDERLINE}https://github.com/npontious/dots-hyprland/commits/main/sdata/dist-${TARGET_ID}${STY_RST}\n"
      printf "\n"
      ...
      printf "${STY_PURPLE}${STY_UNDERLINE}https://github.com/npontious/dots-hyprland/discussions/new?category=extra-distros${STY_RST}\n"
      printf "\n"
