...
- See also [#1061](https://github.com/npontious/dots-hyprland/issues/1061)
...
## Status
Partially works. See [Discussion #2382](https://github.com/npontious/dots-hyprland/discussions/2382).
## plan
...
- Another problem is the location of a suid helper binary that is necessary, see [this comment](https://github.com/npontious/dots-hyprland/issues/1061#issuecomment-3403195230).

As [commented](https://github.com/npontious/dots-hyprland/issues/1061#issuecomment-3403195230) by @Cu3PO42 , both the problem could be solved by using the system-provided libpam instead.
...
- This works but is not elegant. An experimental solution is using yaml config to store the selected behavior for each target, see [#2137](https://github.com/npontious/dots-hyprland/issues/2137).
...
- @end-4 (who develops the dots; see [comment](https://github.com/npontious/dots-hyprland/pull/2278#issuecomment-3454929577)): "I modify my local copy of stuff, copy the relevant parts over, optionally selectively pick changes then commit. It's.... the most obvious way but I guess not necessarily the cleanest"

If we use Nix to handle dotfiles, then it must be at least better than the current state described above, mainly in terms of convenience and automation.

**4. Others**

Find out a good method to avoid what @end-4 [mentioned](https://github.com/npontious/dots-hyprland/issues/1061#issuecomment-2954725029):
...
Some information may help, e.g. @darsh032 [commented](https://github.com/npontious/dots-hyprland/issues/1061#issuecomment-3336839862):
...
And also the "hmrice" [mentioned](https://github.com/npontious/dots-hyprland/issues/1061#issuecomment-3353345504) by @Markus328 , and the `flake.nix` (for quickshell only) [mentioned](https://github.com/npontious/dots-hyprland/issues/1061#issuecomment-3354387126) by @darsh032 .
